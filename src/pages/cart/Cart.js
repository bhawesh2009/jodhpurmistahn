...
const Cart = () => {
	...
	const deliveryFee = cartFoods.length * 0;
				...
				<div className="col-lg-5">
					{cartFoods.length >= 1 && (
						<div className="address-details">
							<h6>
								From <strong>The Soup Loop</strong>
							</h6>
							<p>Arriving in 15-20 min</p>
							{isDelivery && (
								<p>
					...
					{cartFoods.length >= 1 ? (
						...
						<p style={{ color: '#ED553B', fontWeight: 'bold', fontSize: '1.5rem', textAlign: 'center' }}>
