	...
	return (
		<BtnStyle className="container">
			<div className={ `btn-type text-center active-${showItems.property.id}`}>
				<button onClick={handleClick} className="btn mx-3 vegetarian">
					Lunch and Dinner
				</button>
				<button onClick={handleClick} className="btn mx-3 soup">
					Breakfast
				</button>
				<button onClick={handleClick} className="btn mx-3 vegan">
					All india
				</button>
			</div>
